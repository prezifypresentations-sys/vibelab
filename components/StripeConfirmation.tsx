    ...
    <AnimatePresence>
      {show && (
        <div
          ...
          className="animate-on-scroll fixed bottom-6 right-6 z-[100] bg-navy/95 backdrop-blur-md text-cloud p-5 rounded-2xl shadow-2xl flex items-start space-x-4 max-w-md border border-gold/40"
        >
