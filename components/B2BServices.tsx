        ...
        >
          ...
          <div className="relative p-10 md:p-16">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-electric/20 to-gold/10 ring-1 ring-white/10">
                <Cpu className="h-5 w-5 text-electric-light" />
              </div>
              <span className="text-xs font-semibold text-cloud/60 uppercase tracking-[0.2em]">
                B2B · Done-for-you
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-7">
                ...
                <p className="mt-6 max-w-xl text-lg text-cloud/60 leading-relaxed">
                ...
                <div className="mt-10 space-y-4">
                  {items.map(({ icon: Icon, label, desc }, i) => (
                    <motion.div
                      ...
                      className="group flex items-start gap-4 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4 transition-all duration-300 hover:bg-white/[0.05] hover:border-white/[0.12]"
                    >
              ...
              <div className="lg:col-span-5 flex flex-col items-center lg:items-end gap-8 lg:pt-8">
                {/* Metric highlight */}
                <div className="text-center lg:text-right">
                  <div className="flex items-center gap-2 justify-center lg:justify-end">
                    <Zap className="h-5 w-5 text-gold" />
                    <span className="text-xs font-medium text-cloud/50 uppercase tracking-wider">
                      Vidutinis rezultatas
                    </span>
                  </div>
                  <p className="mt-2 font-display text-5xl font-bold bg-gradient-to-r from-gold to-gold-light bg-clip-text text-transparent">
                    3x
                  </p>
                ...
                <a
                  href="#hero"
                  className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gold px-8 py-4 text-base font-semibold text-navy transition-all hover:bg-gold-light hover:shadow-[0_0_40px_rgba(255,222,89,0.4)] animate-pulse-glow"
                >
                  Stoti į eilę
